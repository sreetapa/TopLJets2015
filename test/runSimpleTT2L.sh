...
root -b -q simpleTT2L.C+\(\"MCpp5p2TeV_TT.root\",\"/eos/cms/store/group/phys_top/gkrintir/TopHI/RunIIpp5Spring18DR/TT_TuneCP5_5p02TeV-powheg-pythia8/merged/HiForestAODSIM_94.root\",true,true\)
